(function () {
    ...
    var hoverSelector = 'a, h1, p, rm-card-side, about-avatar, .btn, h3, .services-1, .sr-only-fallback, h2, button, [role="button"], .proj-card, .proj-dot, .skill-pill, .hero-social-link, .proj-arrow';
